...
export default function Products() {
  ...
  // Filtres disponibles (à récupérer depuis l'API dans un cas réel)
  ...
  // État d'expansion des accordéons
  ...
  // (J'ai gardé uniquement la partie qui concerne la vérification de l'authentification)

  // Le reste du composant reste identique
  // ...

  // Appliquer les filtres chaque fois que les filtres ou les produits changent
  useEffect(() => {
    ...
    if (activeFilters.size) {
      result = result.filter((product) => product.size === activeFilters.size)
    }

    // Filtre par disponibilité
    if (activeFilters.availability.includes("outOfStock")) {
      // Simuler un filtre de disponibilité (à adapter selon votre modèle de données)
  ...
  const handleAvailabilityClick = (option) => {
    setActiveFilters((prev) => {
      ...
      if (newAvailability.includes(option)) {
        return {
          ...prev,
          availability: newAvailability.filter((item) => item !== option),
        }
      } else {
        return {
          ...prev,
          availability: [...newAvailability, option],
        }
      }
    })
  }
  ...
  const handleCategoryClick = (category) => {
    setActiveFilters((prev) => {
      ...
      if (newCategories.includes(category)) {
        return {
          ...prev,
          category: newCategories.filter((item) => item !== category),
        }
      } else {
        return {
          ...prev,
  ...
  const handleColorClick = (color) => {
    setActiveFilters((prev) => {
      ...
      if (newColors.includes(color)) {
        return {
          ...prev,
          color: newColors.filter((item) => item !== color),
        }
      } else {
        return {
          ...prev,
  ...
  const handleGenreClick = (genre) => {
    setActiveFilters((prev) => {
      ...
      if (newGenres.includes(genre)) {
        return {
          ...prev,
          genre: newGenres.filter((item) => item !== genre),
        }
      } else {
        return {
          ...prev,
          ...
          <Sidebar>
            ...
            <FilterSection>
              <FilterHeader onClick={() => toggleSection("availability")}>
                ...
                <ExpandIcon>
                  {expandedSections.availability ? <ChevronDown size={18} /> : <ChevronRight size={18} />}
                </ExpandIcon>
              </FilterHeader>
            ...
            <FilterAccordion>
              <FilterHeader onClick={() => toggleSection("priceRange")}>
                ...
                <ExpandIcon>
                  {expandedSections.priceRange ? <ChevronDown size={18} /> : <ChevronRight size={18} />}
                </ExpandIcon>
              </FilterHeader>
            ...
            <FilterAccordion>
              <FilterHeader onClick={() => toggleSection("genre")}>
                ...
                <ExpandIcon>
                  {expandedSections.genre ? <ChevronDown size={18} /> : <ChevronRight size={18} />}
                </ExpandIcon>
              </FilterHeader>
            ...
            <FilterAccordion>
              <FilterHeader onClick={() => toggleSection("ratings")}>
                ...
                <ExpandIcon>
                  {expandedSections.ratings ? <ChevronDown size={18} /> : <ChevronRight size={18} />}
                </ExpandIcon>
              </FilterHeader>
            </FilterAccordion>
          </Sidebar>
